          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  <div className="p-3 rounded-full bg-gradient-to-tr from-yellow-400 to-orange-500">
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-4">
              <div className="flex gap-4">
                <motion.input
                  ...
                  required
                  className="w-1/2 px-4 py-3 rounded-xl focus:ring-2 focus:ring-yellow-500 outline-none bg-white/70 transition"
                />
                <motion.input
                  whileFocus={{ scale: 1.02 }}
                  type="email"
              ...
              <motion.input
                ...
                placeholder="Subject"
                required
                className="w-full px-4 py-3 rounded-xl focus:ring-2 focus:ring-yellow-500 outline-none bg-white/70 transition"
              />
              <motion.textarea
                whileFocus={{ scale: 1.02 }}
                name="message"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 rounded-xl font-semibold transition"
              >
                Send Message
              </motion.button>
            </form>
