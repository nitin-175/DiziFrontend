...
const ProductCard = ({ product }) => (
  <div className="group relative border border-gray-200 rounded-lg p-4 flex flex-col hover:shadow-xl transition">
    <div className="aspect-w-1 aspect-h-1 bg-gray-100 rounded-lg overflow-hidden relative">
      <img src={product.imageUrl} alt={product.name} className="w-full h-full object-center object-cover transform group-hover:scale-105 transition duration-500" />
      {product.tag && (
...
const ReferAFriend = () => (
  <div className="absolute -top-28 left-1/2 -translate-x-1/2 w-[85%] max-w-5xl">
    <div className="bg-gradient-to-br from-orange-500 via-orange-400 to-yellow-300 rounded-lg flex items-center justify-between px-12 pt-24 pb-4 shadow-2xl">
      <div>
        <h2 className="text-white text-xl font-bold tracking-wide">REFER A FRIENDS</h2>
...
export { ProductGrid, ReferAFriend };
