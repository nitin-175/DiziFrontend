...
const ProductCard = ({ gem }) => (
    <div className="bg-white ml-7 mr-7 rounded-lg overflow-hidden group text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 flex flex-col">
    ...
    <div className="relative h-80 md:h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-start text-left">
            <div className="p-8 md:p-12 rounded-lg">
                ...
                <p className="text-gray-200 mt-4 max-w-2xl drop-shadow-md">
                    Discover a curated collection of the world's finest, ethically sourced gems, certified for authenticity.
                </p>
                <div className="mt-8 flex space-x-4">
                    <a href="#" className="px-8 py-3 bg-yellow-400 text-black font-bold rounded-full hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105">
                        Shop Gemstones
                    </a>
                    <a href="#" className="px-8 py-3 bg-white/20 text-white font-bold rounded-full hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
